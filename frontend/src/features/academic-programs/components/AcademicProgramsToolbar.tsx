...
interface AcademicProgramsToolbarProps {
  /** Called when the "New academic program" button is clicked */
  onAdd?: () => void;
}

export function AcademicProgramsToolbar({ onAdd }: AcademicProgramsToolbarProps) {
