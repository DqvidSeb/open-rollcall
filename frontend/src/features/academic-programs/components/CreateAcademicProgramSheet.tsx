...
interface CreateAcademicProgramSheetProps {
  open: boolean;
  onClose: () => void;
  /** Called after the academic program was created successfully. */
  onCreated: () => void;
}
...
export function CreateAcademicProgramSheet({ open, onClose, onCreated }: CreateAcademicProgramSheetProps) {
  ...
  return (
    <>
      <AcademicProgramSheetShell open={open} onClose={onClose} labelledBy="create-academic-program-title">
        {/* Header */}
        <div
          style={{
            display:        'flex',
        ...
        >
          <div>
            <h2 id="create-academic-program-title" style={{ fontSize: '17px', fontWeight: 600, color: 'var(--ct-primary)', letterSpacing: '-0.01em' }}>
              {t('createTitle')}
            </h2>
