...
interface PositionDetailsHeaderProps {
...
export function PositionDetailsHeader({ position, isEditing, onEdit, onDelete, onClose }: PositionDetailsHeaderProps) {
  ...
  return (
    ...
    >
      <div>
        <h2 id="position-details-title" style={{ fontSize: '17px', fontWeight: 600, color: 'var(--ct-primary)', letterSpacing: '-0.01em' }}>
          {position?.name ?? t('detailsTitle')}
        </h2>
