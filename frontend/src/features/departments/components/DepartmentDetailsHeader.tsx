...
interface DepartmentDetailsHeaderProps {
...
export function DepartmentDetailsHeader({ department, isEditing, onEdit, onDelete, onClose }: DepartmentDetailsHeaderProps) {
  ...
  return (
    ...
    >
      <div>
        <h2 id="department-details-title" style={{ fontSize: '17px', fontWeight: 600, color: 'var(--ct-primary)', letterSpacing: '-0.01em' }}>
          {department?.name ?? t('detailsTitle')}
        </h2>
