...
interface CreateDepartmentSheetProps {
  open: boolean;
  onClose: () => void;
  /** Called after the department was created successfully. */
  onCreated: () => void;
}
...
export function CreateDepartmentSheet({ open, onClose, onCreated }: CreateDepartmentSheetProps) {
  ...
  return (
    <>
      <DepartmentSheetShell open={open} onClose={onClose} labelledBy="create-department-title">
        {/* Header */}
        <div
          style={{
            display:        'flex',
        ...
        >
          <div>
            <h2 id="create-department-title" style={{ fontSize: '17px', fontWeight: 600, color: 'var(--ct-primary)', letterSpacing: '-0.01em' }}>
              {t('createTitle')}
            </h2>
